...
// GeoipConfig4 GeoIP config update schema.
type GeoipConfig4 struct {
...
func (o GeoipConfig4) MarshalJSON() ([]byte, error) {
...
type NullableGeoipConfig4 struct {
	value *GeoipConfig4
	isSet bool
}

func (v NullableGeoipConfig4) Get() *GeoipConfig4 {
	return v.value
}

func (v *NullableGeoipConfig4) Set(val *GeoipConfig4) {
	v.value = val
	v.isSet = true
}

func (v NullableGeoipConfig4) IsSet() bool {
	return v.isSet
}

func (v *NullableGeoipConfig4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGeoipConfig4(val *GeoipConfig4) *NullableGeoipConfig4 {
	return &NullableGeoipConfig4{value: val, isSet: true}
}

func (v NullableGeoipConfig4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGeoipConfig4) UnmarshalJSON(src []byte) error {
	v.isSet = true
