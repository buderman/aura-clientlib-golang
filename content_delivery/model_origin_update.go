...
func (o OriginUpdate) MarshalJSON() ([]byte, error) {
...
type NullableOriginUpdate struct {
	value *OriginUpdate
	isSet bool
}

func (v NullableOriginUpdate) Get() *OriginUpdate {
	return v.value
}

func (v *NullableOriginUpdate) Set(val *OriginUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableOriginUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableOriginUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOriginUpdate(val *OriginUpdate) *NullableOriginUpdate {
	return &NullableOriginUpdate{value: val, isSet: true}
}

func (v NullableOriginUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOriginUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
