...
// CdnPrefix1 A CDN prefix corresponds to the fully qualified domain name (FQDN) at the beginning of a URI, effectively carving out a region of the URI name space to which a set of rules and policies are applied.
type CdnPrefix1 struct {
...
func (o CdnPrefix1) MarshalJSON() ([]byte, error) {
...
type NullableCdnPrefix1 struct {
	value *CdnPrefix1
	isSet bool
}

func (v NullableCdnPrefix1) Get() *CdnPrefix1 {
	return v.value
}

func (v *NullableCdnPrefix1) Set(val *CdnPrefix1) {
	v.value = val
	v.isSet = true
}

func (v NullableCdnPrefix1) IsSet() bool {
	return v.isSet
}

func (v *NullableCdnPrefix1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCdnPrefix1(val *CdnPrefix1) *NullableCdnPrefix1 {
	return &NullableCdnPrefix1{value: val, isSet: true}
}

func (v NullableCdnPrefix1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCdnPrefix1) UnmarshalJSON(src []byte) error {
	v.isSet = true
