...
// TlsIngestProfile2 TLS ingest profile create
type TlsIngestProfile2 struct {
...
func (o TlsIngestProfile2) MarshalJSON() ([]byte, error) {
...
type NullableTlsIngestProfile2 struct {
	value *TlsIngestProfile2
	isSet bool
}

func (v NullableTlsIngestProfile2) Get() *TlsIngestProfile2 {
	return v.value
}

func (v *NullableTlsIngestProfile2) Set(val *TlsIngestProfile2) {
	v.value = val
	v.isSet = true
}

func (v NullableTlsIngestProfile2) IsSet() bool {
	return v.isSet
}

func (v *NullableTlsIngestProfile2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTlsIngestProfile2(val *TlsIngestProfile2) *NullableTlsIngestProfile2 {
	return &NullableTlsIngestProfile2{value: val, isSet: true}
}

func (v NullableTlsIngestProfile2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTlsIngestProfile2) UnmarshalJSON(src []byte) error {
	v.isSet = true
