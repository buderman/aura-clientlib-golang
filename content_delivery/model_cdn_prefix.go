...
func (o CdnPrefix) MarshalJSON() ([]byte, error) {
...
type NullableCdnPrefix struct {
	value *CdnPrefix
	isSet bool
}

func (v NullableCdnPrefix) Get() *CdnPrefix {
	return v.value
}

func (v *NullableCdnPrefix) Set(val *CdnPrefix) {
	v.value = val
	v.isSet = true
}

func (v NullableCdnPrefix) IsSet() bool {
	return v.isSet
}

func (v *NullableCdnPrefix) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCdnPrefix(val *CdnPrefix) *NullableCdnPrefix {
	return &NullableCdnPrefix{value: val, isSet: true}
}

func (v NullableCdnPrefix) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCdnPrefix) UnmarshalJSON(src []byte) error {
	v.isSet = true
