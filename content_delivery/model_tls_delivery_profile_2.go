...
// TlsDeliveryProfile2 TLS delivery profile create
type TlsDeliveryProfile2 struct {
...
func (o TlsDeliveryProfile2) MarshalJSON() ([]byte, error) {
...
type NullableTlsDeliveryProfile2 struct {
	value *TlsDeliveryProfile2
	isSet bool
}

func (v NullableTlsDeliveryProfile2) Get() *TlsDeliveryProfile2 {
	return v.value
}

func (v *NullableTlsDeliveryProfile2) Set(val *TlsDeliveryProfile2) {
	v.value = val
	v.isSet = true
}

func (v NullableTlsDeliveryProfile2) IsSet() bool {
	return v.isSet
}

func (v *NullableTlsDeliveryProfile2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTlsDeliveryProfile2(val *TlsDeliveryProfile2) *NullableTlsDeliveryProfile2 {
	return &NullableTlsDeliveryProfile2{value: val, isSet: true}
}

func (v NullableTlsDeliveryProfile2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTlsDeliveryProfile2) UnmarshalJSON(src []byte) error {
	v.isSet = true
