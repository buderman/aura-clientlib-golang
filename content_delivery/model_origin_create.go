...
func (o OriginCreate) MarshalJSON() ([]byte, error) {
...
type NullableOriginCreate struct {
	value *OriginCreate
	isSet bool
}

func (v NullableOriginCreate) Get() *OriginCreate {
	return v.value
}

func (v *NullableOriginCreate) Set(val *OriginCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableOriginCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableOriginCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOriginCreate(val *OriginCreate) *NullableOriginCreate {
	return &NullableOriginCreate{value: val, isSet: true}
}

func (v NullableOriginCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOriginCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
