...
// OriginReadDetailed Origin update.
type OriginReadDetailed struct {
...
func (o OriginReadDetailed) MarshalJSON() ([]byte, error) {
...
type NullableOriginReadDetailed struct {
	value *OriginReadDetailed
	isSet bool
}

func (v NullableOriginReadDetailed) Get() *OriginReadDetailed {
	return v.value
}

func (v *NullableOriginReadDetailed) Set(val *OriginReadDetailed) {
	v.value = val
	v.isSet = true
}

func (v NullableOriginReadDetailed) IsSet() bool {
	return v.isSet
}

func (v *NullableOriginReadDetailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOriginReadDetailed(val *OriginReadDetailed) *NullableOriginReadDetailed {
	return &NullableOriginReadDetailed{value: val, isSet: true}
}

func (v NullableOriginReadDetailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOriginReadDetailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
